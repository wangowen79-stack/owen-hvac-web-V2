  ...
  return (
    <div>
      ...
      <section style={{
        ...
        background: 'linear-gradient(145deg, #1E3A5F 0%, #234670 35%, #2A4D78 70%, #356090 100%)',
        position: 'relative', overflow: 'hidden', paddingTop: 80,
      }}>
        <div style={{ position: 'absolute', inset: 0, backgroundImage: 'radial-gradient(circle at 75% 25%, rgba(232,139,48,0.14) 0%, transparent 55%), radial-gradient(circle at 20% 80%, rgba(240,192,64,0.1) 0%, transparent 50%)' }} />
        ...
        <div className="container" style={{ position: 'relative', width: '100%', padding: '60px 24px' }}>
          <div className="grid-2">
            <div>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'rgba(232,139,48,0.14)', padding: '8px 16px', borderRadius: 30, marginBottom: 24, border: '1px solid rgba(232,139,48,0.2)', animation: 'fadeUp 0.6s ease both' }}>
            ...
            <div style={{ position: 'relative', animation: 'fadeIn 1s ease both 0.3s' }}>
              ...
              <div style={{ position: 'absolute', bottom: -20, left: -30, background: 'rgba(255,255,255,0.95)', backdropFilter: 'blur(10px)', borderRadius: 16, padding: '14px 18px', boxShadow: '0 10px 36px rgba(0,0,0,0.12)', animation: 'float 5s ease-in-out infinite', maxWidth: 180, zIndex: 2 }}>
